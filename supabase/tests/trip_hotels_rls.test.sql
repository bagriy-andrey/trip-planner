...
insert into public.trip_hotels (id, trip_id, name, city_place_id, time_zone, check_in_date, check_out_date) values ('e2000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000001', 'H', 'city-porto', 'Europe/Lisbon', '2026-06-01', '2026-06-02');
insert into public.trip_hotels (id, trip_id, name, city_place_id, time_zone, check_in_date, check_out_date) values ('e2000000-0000-4000-8000-000000000002', 'b0000000-0000-4000-8000-000000000001', 'H', 'city-porto', 'Europe/Lisbon', '2026-06-02', '2026-06-03');
insert into public.trip_hotels (id, trip_id, name, city_place_id, time_zone, check_in_date, check_out_date) values ('e2000000-0000-4000-8000-000000000003', 'c0000000-0000-4000-8000-000000000001', 'H', 'city-porto', 'Europe/Lisbon', '2026-06-03', '2026-06-04');
...
select lives_ok($q$insert into public.trip_hotels (id, trip_id, name, city_place_id, time_zone, check_in_date, check_out_date) values ('e2000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000001', 'H', 'city-porto', 'Europe/Lisbon', '2026-06-05', '2026-06-06')$q$, 'owner insert: hotel on own trip accepted');
...
select throws_ok($q$insert into public.trip_hotels (trip_id, name, city_place_id, time_zone, check_in_date, check_out_date) values ('b0000000-0000-4000-8000-000000000001', 'H', 'city-porto', 'Europe/Lisbon', '2026-06-06', '2026-06-07')$q$, '42501', null, 'insert into someone else''s trip is rejected');
select throws_ok($q$insert into public.trip_hotels (trip_id, name, city_place_id, time_zone, check_in_date, check_out_date) values ('dddddddd-0000-4000-8000-000000000000', 'H', 'city-porto', 'Europe/Lisbon', '2026-06-06', '2026-06-07')$q$, '42501', null, 'insert with nonexistent trip_id is rejected');
...
select throws_ok($q$insert into public.trip_hotels (trip_id, name, city_place_id, time_zone, check_in_date, check_out_date) values ('a0000000-0000-4000-8000-000000000001', 'H', 'city-porto', 'Europe/Lisbon', '2026-06-07', '2026-06-08')$q$, '42501', null, 'anon insert is rejected');
reset role;
